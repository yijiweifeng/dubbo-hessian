...
var _hessianProxyCn = require('hessian-proxy-cn');

var _hessianProxyCn2 = _interopRequireDefault(_hessianProxyCn);
...
var _class = function (_events$EventEmitter) {
                        ...
                        case 17:
                            ...
                            domains.keys.forEach(function (clzName) {
                                domains[clzName].methods.forEach(function (method) {
                                            ...
                                            default:
                                                ...
                                                if (domains.indexOf(type_) > -1) {
                                                    if (isArray === true) {
                                                        ...
                                                        fns.push(function (value) {
                                                            if (value !== null && value !== undefined) {
                                                                value = _toolkit2.default.dataCheck(value, type_);
                                                            }
                                                            return value;
                                                        });
                                                    }
                                    ...
                                    _this2.services[name][method.name] = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
                                        var args,
                                            _args = arguments;
                                            ...
                                            while (1) {
                                                switch (_context.prev = _context.next) {
                                                    ...
                                                    case 3:
                                                        ...
                                                        _context.next = 6;
                                                        return self.invoke(clzName, method.name, args);
                                    ...
                                    _this2.services[name][method.name].check = fns;
                                });
                            });
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            this.host = {};
                            children = this.getChildren('/' + this.service_group, function () {
                                _this3.readNode();
                            });

                            children.forEach(function (node) {
                                _this3.host[node] = [];
                                var services = _this3.getChildren('/' + _this3.service_group + '/' + node + '/' + vider);
                                ...
                                services.forEach(function (service) {
                                    ...
                                    _this3.consumer.host = host + '/' + node;
                                    _this3.consumer.query.revision = _this3.consumer.query.version = ser_param['default.version'] || ser_param['version'];
                                    _this3.consumer.query.timestamp = new Date().getTime();
                                    _this3.host[node].push(ser_host.host);
                                    _this3.addNode('/' + _this3.service_group + '/' + node + '/consumers/' + encodeURIComponent(_url2.default.format(info)));
                                });
                            });
    ...
    _class.prototype.init = function init() {
        ...
        this.client.once('connected', function () {
            ...
            _this4.getChildren = _toolkit2.default.P(_this4.client.getChildren);
            _this4.exists = _toolkit2.default.P(_this4.client.exists);
            _this4.readNode();
    ...
    _class.prototype.invoke = function invoke(clzName, methodName, args) {
        ...
        return new _promise2.default(function (resolve, reject) {
            ...
            domain_.run(function () {
                var proxy = new _hessianProxyCn2.default('http://' + host + '/' + clzName, _this5.username, _this5.password, proxy);
