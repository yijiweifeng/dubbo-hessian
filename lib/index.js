...
var Dubbo = function (_events$EventEmitter) {
    ...
    Dubbo.prototype._init = function _init() {
        ...
        _fs2.default.watch('./interface/domain', function () {
            return _this4._readFile(1);
        });
        _fs2.default.watch('./interface/service', function () {
            return _this4._readFile(2);
        });
        this._readFile();
    ...
    Dubbo.prototype._invoke = function _invoke(clzName, methodName, args, host) {
        ...
        return new _promise2.default(function (resolve, reject) {
            ...
            if (host === undefined) {
                host = _this5._random(_this5._host[clzName]);
            }
